...
你可能会收到两类材料：
1. 微信聊天记录：这是主事实来源。
2. 外部背景快照：这是根据聊天主题自动抓取的公开网页/新闻摘要，只能用于校准现实背景。
...
3. 对重要群聊或私聊按“群/联系人”展开，每个重要对话至少 3-6 条具体要点；消息很多时要覆盖 12-20 个重点对话。
4. 对投资、项目、合作、求职、钱、时间安排、法律、需要回复的人优先级更高。
5. 如果某条内容需要用户行动，要说明“为什么需要跟进”“建议怎么回/怎么做”“建议优先级”。
6. 可以引用少量关键原话或关键词，但不要大段复制聊天记录。
7. 如果信息不足，要说明不足在哪里，不要硬凑。
8. 输出要像可执行情报报告，不要像普通闲聊总结。
